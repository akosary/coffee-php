...
// let data, liNumber, rows, rowLength;
// let rowsAlreadyGit = [];
// let mainInformation = [];
// let stopFunction = 0;
// var total=0;

// async function getorders(num) {
...
// getorders("count").then(() => {
//   if (stopFunction === 0) {
//     setSlideNumbers(data).then(() => {
//       displayorders(data);
//     });
//   }
//   OnclickSliderNumber();
...
//   row.classList.add("displayActive");
...
async function getorders(no , perPage) {
    ...
    getCount("http://localhost/coffee-php/getpagenumber.php");
    let res = await fetch("http://localhost/coffee-php/order.php",
    {
        method: "post",
        headers: {
...
async function get_orders(per,no){
    getCcount("http://localhost/coffee-php/countofordersbydate.php");
    // document.querySelector("tbody").innerHTML="";
    console.log("nn");
    let res = await fetch("http://localhost/coffee-php/ordersbydate.php",
    {
        method: "post",
        headers: {
            "Content-Type": "application/json",
